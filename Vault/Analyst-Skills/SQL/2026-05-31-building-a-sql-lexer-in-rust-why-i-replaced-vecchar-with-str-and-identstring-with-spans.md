...
title: 'Building a SQL Lexer in Rust: Why I Replaced `Vec<char>` with `&str` and `Ident(String)`
  with Spans'
date: '2026-05-31'
source: https://dev.to/musab0986/building-a-sql-lexer-in-rust-why-i-replaced-vec-with-str-and-identstring-with-spans-2ng2
domain: SQL
relevance: 🟡
tags:
- '#sql'
...
## Source
https://dev.to/musab0986/building-a-sql-lexer-in-rust-why-i-replaced-vec-with-str-and-identstring-with-spans-2ng2
